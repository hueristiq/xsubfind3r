...
//     domain-related patterns, ensuring consistent parsing.
//
// Example Usage:
//
//	cfg := Configuration{
...
//
// Fields:
//   - Bevigil, BuiltWith, Censys, etc. (SourceKeys): Slices of strings containing API keys
